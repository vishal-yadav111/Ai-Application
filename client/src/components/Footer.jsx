...
const Footer = () => {
  return (
            ...
            <div>
                ...
                <div className="text-sm space-y-2">
                    ...
                    <div className="flex items-center gap-2 pt-4">
                        ...
                        <button className="bg-[#0f172a] w-24 h-9 text-white rounded cursor-pointer">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © Yash Sharma. All Right Reserved.
    </p>
</footer>
  )
}
