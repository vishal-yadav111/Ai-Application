  ...
  return (
    ...
    justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
        ...
        <div className='text-center mb-6'>
            ...
            font-semibold mx-auto leading-[1.2]'>Create amazing content <br />with <span className='
            text-[#5044e5]'>AI tools</span></h1>
        ...
        <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
            <button onClick={() => navigate('/ai')} className='bg-[#0f172a] text-white px-10 py-3 rounded-lg
            ...
            border-gray-300 hover:scale-102 active:scale-95 transition cursor-pointer ml-4'>Watch demo</button>
        </div>
        <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
            <img src={assets.user_group} alt='' className='h-8' />Trusted by 11k+ people
        </div>
